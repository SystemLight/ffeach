...
export default class FileForeach {
...
export function ffeach(file: File, chunkSize: number) {
    return new FileForeach(file, chunkSize);
}

export function hashFile(file: File, callback: (result: string) => void, chunkSize) {
